package com.robotacid.gfx {
    ...
    public class Renderer{
        ...
        public var mode3DButtonBlit:BlitClip;
        ...
        public var mode3D:Boolean = false;
        public var perspectiveSkewX:Number = 0.3;
        public var perspectiveSkewY:Number = 0.2;
        ...
        /* Apply 3D isometric projection to coordinates */
        public function apply3DProjection(x:Number, y:Number, z:Number = 0):Point{
            if(!mode3D){
                return new Point(x, y);
            }
            var projX:Number = x - y * perspectiveSkewX;
            var projY:Number = (x + y) * 0.5 - z * perspectiveSkewY;
        ...
        public function init():void{
            ...
            mode3DButtonBlit = new BlitClip(menuSpriteSheet, [
                new Rectangle(72, 48, 12, 12),
                new Rectangle(84, 48, 12, 12)
            ]);
